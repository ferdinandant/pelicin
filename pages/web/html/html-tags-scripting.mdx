...
Used to draw graphics with <a href="https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API">canvas scripting API</a> or <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API">WebGL API</a>.

<Badge color="blue">Possible attributes</Badge>
<ul>
  <li>
    <Attribute>height=[...]</Attribute> &mdash; height of the canvas
  </li>
  <li>
    <Attribute>width=[...]</Attribute> &mdash; width of the canvas
  </li>
</ul>
