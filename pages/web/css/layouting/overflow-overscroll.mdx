...
<MetadataConfigurer title="Overflow and Overscroll" dateCreated="2021-03-14" />
...
(Which direction this is depends on `writing-mode`, `direction`, and `text-orientation` values. Normally refers to the horizontal axis when you write horizontally.)

### `overflow-block`

Sets the overflow behavior for the block direction.

(Which direction this is depends on `writing-mode`, `direction`, and `text-orientation` values. Normally refers to the vertical axis when you write horizontally.)
