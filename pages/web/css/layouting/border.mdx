...
Defines how the image should be sliced into 9 regions.
...
If you add the `fill` keyword (e.g. `border-image-slice: 10px 10px fill`), the middle region will be displayed like a background image, but stacked above the actual `background`.
  ...
  references={[
    {
      ...
      used: 'https://developer.mozilla.org/en-US/docs/Web/CSS/border-image',
      link: `https://interactive-examples.mdn.mozilla.net/media/examples/border-diamonds.png`,
    },
    {
      text: 'Border image slice example (MDN)',
      used: 'https://developer.mozilla.org/en-US/docs/Web/CSS/border-image-slice',
