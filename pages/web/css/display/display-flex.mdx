...
<NoteBox type="info">
  ...
  <p>
    <em>"Justify along main axis, align along cross axis"</em>
  </p>
</NoteBox>
...
Defines how items are aligned along the main-axis, if there's an extra space.
...
Defines how items are aligned along the cross-axis, if there's an extra space.
