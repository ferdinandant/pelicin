...
(Alternatively, you can use `grid-column-*` and `grid-row-*` on the grid items to specify their locations in the grid.)
...
Shorthand for setting _all_ of the explicit and implicit grid properties in a single declaration (`grid-template-rows`, `grid-template-columns`, and `grid-template-areas`, `grid-auto-rows`, `grid-auto-columns`, and `grid-auto-flow`).
...
<DocumentationList
  items={[
    ...
    },
    {
      ...
      description: (
        <>
          Place the item from the column line whose name is <Code str="lineName-start" /> or{' '}
          <Code str="lineName" />.
        </>
      ),
    },
    {
      ...
      description: (
        <>
          ...
          <Code str="number" />
          -th column line (counting backwards if it is negative). If <Code str="lineName" /> is specified,
    ...
    },
    {
      ...
      description: (
        <>
          E.g. <Code str="span 3" /> or <Code str="span my-line 3" />. Place the item's column start
          line <Code str="number" /> lines away from the column end line. (See{' '}
          <Code str="grid-column-end" /> value or place the item automatically first to determine
          the column end line.) If <Code str="lineName" /> is specified, then only lines with that
          name is counted.
        </>
      ),
    },
...
<DocumentationList
  items={[
    ...
    },
    {
      ...
      description: (
        <>
          Place the item until the column line whose name is <Code str="lineName-end" /> or{' '}
          <Code str="lineName" />.
        </>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <>
          E.g. <Code str="span 3" /> or <Code str="span my-line 3" />. Place the item's column end
          line <Code str="number" /> lines away from the column start line. (See{' '}
          <Code str="grid-column-start" /> value or place the item automatically first to determine
          the column start line.) If <Code str="lineName" /> is specified, then only lines with that
          name is counted.
        </>
      ),
    },
...
(See `grid-column-start` explanation for the list of possible values.)

### `grid-row-end`

Specifies a grid item's position in the grid.

(See `grid-column-end` explanation for the list of possible values.)
