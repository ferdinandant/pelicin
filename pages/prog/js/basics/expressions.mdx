...
Checks if an object is an instance of another object, that is, `a instanceof b` returns `true` if `a.prototype` inherits from `b.prototype`. (It will become clear once we talk about [classes](#TODO).)
