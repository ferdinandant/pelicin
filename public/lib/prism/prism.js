                    ...
                    for (
                      ...
                      if (!(k instanceof W)) {
                        ...
                        if (h) {
                          ...
                          for (
                            var S = m;
                            S !== r.tail && (P < A || 'string' == typeof S.value);
                            S = S.next
                          )
                            x++, (P += S.value.length);
...
!(function (e) {
  ...
  e.languages.apex = {
    ...
    'class-name': [
      ...
      { pattern: i('(\\(\\s*)<CLASS-NAME>(?=\\s*\\)\\s*[\\w(])'), lookbehind: !0, inside: a },
...
Prism.languages.autoit = {
  comment: [
    /;.*/,
    { pattern: /(^\s*)#(?:comments-start|cs)[\s\S]*?^[ \t]*#(?:comments-end|ce)/m, lookbehind: !0 },
  ],
...
(Prism.languages.chaiscript = Prism.languages.extend('clike', {
  ...
  Prism.languages.insertBefore('chaiscript', 'operator', {
    'parameter-type': { pattern: /([,(]\s*)\w+(?=\s+\w)/, lookbehind: !0, alias: 'class-name' },
  }),
  ...
  var t = {
    ...
    i = {
      ...
      'stack-effect-delimiter': [
        { pattern: /(^|\s)(?:call|execute|eval)?\((?=\s)/, lookbehind: !0, alias: 'operator' },
      ...
      if ("'" != t) {
        ...
        '$' === t && (n = /([^\$])(?:\$(?:\{.*?\}|[\w.]+))/),
          ...
          (e.content = Prism.highlight(e.content, {
            expression: { pattern: n, lookbehind: !0, inside: Prism.languages.groovy },
          })),
...
!(function (e) {
  e.languages.haml = {
    ...
    tag: {
      ...
      inside: {
        attributes: [
          { pattern: /(^|[^#])\{(?:\{[^}]+\}|[^{}])+\}/, lookbehind: !0, inside: e.languages.ruby },
          {
            pattern: /\([^)]+\)/,
            inside: {
...
!(function (a) {
  ...
  (a.languages.javadoc = a.languages.extend('javadoclike', {})),
    a.languages.insertBefore('javadoc', 'keyword', {
      reference: {
        pattern: RegExp(
          '(@(?:exception|throws|see|link|linkplain|value)\\s+(?:\\*\\s*)?)(?:' + n + ')'
        ),
        lookbehind: !0,
        inside: {
      ...
      'code-section': [
        {
          ...
          lookbehind: !0,
          inside: {
            code: { pattern: e, lookbehind: !0, inside: a.languages.java, alias: 'language-java' },
          },
        },
        {
...
!(function (e) {
  ...
  (d['embedded-scheme'].inside.scheme.inside['embedded-lilypond'].inside.lilypond.inside = d),
    (e.languages.ly = d);
})(Prism);
      ...
      table: {
        ...
        inside: {
          'table-data-rows': {
            ...
            lookbehind: !0,
            inside: {
              'table-data': { pattern: RegExp(e), inside: u.languages.markdown },
              punctuation: /\|/,
            },
          },
          'table-line': {
...
!(function (a) {
  ...
  (a.languages.phpdoc = a.languages.extend('javadoclike', {
    parameter: {
      pattern: RegExp(
        '(@(?:global|param|property(?:-read|-write)?|var)\\s+(?:' + e + '\\s+)?)\\$\\w+'
      ),
      lookbehind: !0,
    },
  })),
...
!(function (e) {
  var t = '(?:"(?:""|[^"])*"(?!")|\'(?:\'\'|[^\'])*\'(?!\'))',
    ...
    y = {
      pattern: RegExp(
        '(^|\\s)(?:action\\s+)?(?:<act>)\\.[a-z]+\\b[^;]+'.replace(/<act>/g, function () {
          return k;
        }),
        'i'
      ),
  ...
  e.languages.sas = {
    ...
    'proc-args': {
      pattern: RegExp(
        '(^proc\\s+\\w+\\s+)(?!\\s)(?:[^;"\']|<str>)+;'.replace(/<str>/g, function () {
          return t;
        }),
        'im'
      ),
  ...
  (i.interpolation = {
    ...
    (e.languages.stylus = {
      ...
      'property-declaration': {
        ...
        lookbehind: !0,
        inside: {
          property: { pattern: /^[^\s:]+/, inside: { interpolation: i.interpolation } },
          rest: i,
        },
      },
      selector: {
...
!(function (r) {
  (r.languages.xquery = r.languages.extend('markup', {
    ...
    (r.languages.xquery.tag.pattern = /<\/?(?!\d)[^\s>\/=$<%]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\[\s\S]|{(?!{)(?:{(?:{[^{}]*}|[^{}])*}|[^{}])+}|(?!\1)[^\\])*\1|[^\s'">=]+))?)*\s*\/?>/i),
    (r.languages.xquery.tag.inside[
      'attr-value'
    ].pattern = /=(?:("|')(?:\\[\s\S]|{(?!{)(?:{(?:{[^{}]*}|[^{}])*}|[^{}])+}|(?!\1)[^\\])*\1|[^\s'">=]+)/i),
      ...
      for (var t = [], n = 0; n < e.length; n++) {
        ...
        if (
          ('string' != typeof a &&
            ('tag' === a.type && a.content[0] && 'tag' === a.content[0].type
              ? '</' === a.content[0].content[0].content
                ? 0 < t.length && t[t.length - 1].tagName === s(a.content[0].content[1]) && t.pop()
                : '/>' === a.content[a.content.length - 1].content ||
                  t.push({ tagName: s(a.content[0].content[1]), openedBraces: 0 })
              : !(0 < t.length && 'punctuation' === a.type && '{' === a.content) ||
                (e[n + 1] && 'punctuation' === e[n + 1].type && '{' === e[n + 1].content) ||
                (e[n - 1] && 'plain-text' === e[n - 1].type && '{' === e[n - 1].content)
              ? 0 < t.length &&
                ...
                : 'comment' !== a.type && (o = !0)
              : t[t.length - 1].openedBraces++),
          (o || 'string' == typeof a) && 0 < t.length && 0 === t[t.length - 1].openedBraces)
        ) {
          var i = s(a);
          n < e.length - 1 &&
            ...
            /^\s+$/.test(i) ? (e[n] = i) : (e[n] = new r.Token('plain-text', i, null, i));
        }
...
!(function (n) {
  ...
  var r = /\b(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)\b/,
    ...
    s =
      ...
      '\\s*)*' +
      '(?:\\bpromise\\b|(?:\\berror\\.)?<ID>(?:\\.<ID>)*(?!\\s+<ID>))'.replace(/<ID>/g, e(a)) +
      ')+';
  (n.languages.zig = {
